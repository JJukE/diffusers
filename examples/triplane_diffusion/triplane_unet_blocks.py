...
"""
Added UNetMidBlockTriplane, DownBlockTriplane, ResnetDownsampleBlockTriplane,
UpBlockTriplane, ResnetUpsampleBlockTriplane
""" # TODO: attention blocks not added
...
from triplane_resnet import (
# from .triplane_resnet import (
    Downsample2D,
    DownsampleTriplane, # added
    FirDownsample2D,
    FirUpsample2D,
    KDownsample2D,
    KUpsample2D,
    ...
    Upsample2D,
    UpsampleTriplane, # added
    ResnetBlockTriplane, # added
    ResnetBlockCondNormTriplane, # added
)
...
def get_down_block(
    ...
    elif down_block_type == "DownBlockTriplane":
        return DownBlockTriplane(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
    ...
    elif down_block_type == "ResnetDownsampleBlockTriplane":
        return ResnetDownsampleBlockTriplane(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
...
def get_up_block(
    ...
    elif up_block_type == "UpBlockTriplane":
        return UpBlockTriplane(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
    ...
    elif up_block_type == "ResnetUpsampleBlockTriplane":
        return ResnetUpsampleBlockTriplane(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
...
class UNetMidBlockTriplane(nn.Module):
    """
    A 2D UNet mid-block with multiple residual blocks and optional attention blocks that deals with triplanes.
...
class DownBlockTriplane(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class ResnetDownsampleBlockTriplane(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class UpBlockTriplane(nn.Module):
    def __init__(
        self,
        in_channels: int,
        prev_output_channel: int,
...
class ResnetUpsampleBlockTriplane(nn.Module):
    def __init__(
        self,
        in_channels: int,
        prev_output_channel: int,
